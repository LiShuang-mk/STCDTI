...
def train_and_validate(cfg, solver: core.Engine, step=1):
    ...
    for i in range(0, cfg.train.num_epoch, step):
        ...
        solver.train(**kwargs)
        solver.save("ProtSTMMP_task_epoch_%d.pth" % solver.epoch)
        torch.save(solver.model.protein_model.state_dict(), f"ProtSTMMP_{type(solver.model.protein_model).__name__}_epoch_{solver.epoch}.pth")
